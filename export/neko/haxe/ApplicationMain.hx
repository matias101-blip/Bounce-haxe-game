...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Bounce-game", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Bounce-game", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Bounce-game";
		app.meta["name"] = "Bounce-game";
